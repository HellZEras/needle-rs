...
use crate::{errors::WinErrors, traits::{Is32bitsProcess, MapMemory, ToU8Vec}, utils::{bytes2string, prepare_process_entry}, win_funcs::{create_tool_help_32_snapshot, get_module_base_name_a, is_syswow_64, open_process, process_32_next, read_process_memory, virtual_query_ex}};
...
impl Process {
    pub fn by_pid(process_id: u32) -> Result<Self,WinErrors> {
    ...
    pub fn first_by_name(name:&str) -> Result<Self,WinErrors>{
